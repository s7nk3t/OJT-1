...
<?php } else { ?>                  <td><?php  echo htmlentities($row->Status);?>
                  ...
                  <?php } ?>             
										...
										<td><a href="complete-appointment.php?editid=<?php echo htmlentities($row->ID);?>&&aptid=<?php echo htmlentities ($row->AppointmentNumber);?>" class="btn btn-success">Completed</a></td>
								 <?php $cnt=$cnt+1;}} ?> 
